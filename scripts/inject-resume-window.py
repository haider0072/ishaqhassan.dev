...
if 'id="win-resume"' in content:
    ...
    WIN_RESUME = (
        ...
        ' <a class="sb-item sb-download" href="/assets/resume/Ishaq_Hassan_Resume.pdf" download>'
        ...
        ' <a class="sb-item sb-download" href="/assets/resume/Ishaq_Hassan_Resume.docx" download>'
        ...
        ' <a class="sb-item sb-download" href="/assets/resume/Ishaq_Hassan_Resume.txt" download>'
        ...
        ' <a class="resume-cta-primary" href="/assets/resume/Ishaq_Hassan_Resume.pdf" download>Download PDF</a>'
        ' <a class="resume-cta-ghost" href="/assets/resume/Ishaq_Hassan_Resume.docx" download>DOCX (ATS)</a>'
        ' <a class="resume-cta-ghost" href="/assets/resume/Ishaq_Hassan_Resume.txt" download>Plain Text</a>'
        ' </div>'
        ' </article>'
        # === EXPERIENCE ===
...
if 'id="mobile-resume-expanded"' in content:
    ...
    MOB_EXPANDED = (
        ...
        ' <a class="mob-resume-btn primary" href="/assets/resume/Ishaq_Hassan_Resume.pdf" download>Download PDF</a>'
        ' <a class="mob-resume-btn ghost" href="/assets/resume/Ishaq_Hassan_Resume.docx" download>DOCX</a>'
        ' </div>'
        ' </div>'
        ...
        ' <a class="mob-resume-btn primary" href="/assets/resume/Ishaq_Hassan_Resume.pdf" download>📄 PDF (2 pages)</a>'
        ' <a class="mob-resume-btn ghost" href="/assets/resume/Ishaq_Hassan_Resume.docx" download>📋 DOCX (ATS)</a>'
        ' <a class="mob-resume-btn ghost" href="/assets/resume/Ishaq_Hassan_Resume.txt" download>📃 Plain Text</a>'
        ' </div>'
        ' </div>'
        ' </div>'
        ' </div>'
