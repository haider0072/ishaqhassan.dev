...
<h2>Download</h2>
<ul>
  <li><a href="/assets/resume/Ishaq_Hassan_Resume.pdf?v=1" download>PDF (2 pages, ATS-optimised)</a></li>
  <li><a href="/assets/resume/Ishaq_Hassan_Resume.docx?v=1" download>DOCX (best for Workday, Greenhouse, Lever, Taleo, iCIMS, BambooHR)</a></li>
  <li><a href="/assets/resume/Ishaq_Hassan_Resume.txt?v=1" download>Plain text (for legacy ATS forms)</a></li>
</ul>
<h2>Highlights</h2>
<ul>
